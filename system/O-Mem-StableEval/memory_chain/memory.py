...
class MemoryChain:
    ...
    def reorganize_profile_base_on_message(self,message):
        ...
        reorganized_profile = call_llm_json_sync_with_retries(
            self.client,
            self.model,
            messages,
            temperature=0.7,
            max_tokens=2000,
            retries=5,
            validator=lambda obj: require_keys(obj, ["relevant_profile", "summary"], "reorganized profile payload"),
            label="reorganize_profile_base_on_message",
        )
