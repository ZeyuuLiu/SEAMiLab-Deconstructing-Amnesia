...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate MemoryOS LoCoMo result json")
    parser.add_argument("--input", default="all_loco_results.json", help="Path to result json produced by main_loco_parse.py")
