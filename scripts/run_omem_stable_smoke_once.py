...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run one real stable O-Mem smoke evaluation.")
    parser.add_argument("--sample-id", default="", help="Target sample_id, e.g. conv-30")
    ...
    embedding_path = PROJECT_ROOT / "Qwen" / "Qwen3-Embedding-0.6B"
